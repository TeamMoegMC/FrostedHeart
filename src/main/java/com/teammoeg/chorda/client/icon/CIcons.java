...
public class CIcons {
    ...
    static class AnimatedIcon extends CIcon {
        private static final MapCodec<AnimatedIcon> CODEC = RecordCodecBuilder.mapCodec(t -> t.group(
                Codec.list(CIcons.CODEC).fieldOf("icons").forGetter(o -> o.icons)
        ).apply(t, AnimatedIcon::new));
    ...
    static class CombinedIcon extends CIcon {
        private static final MapCodec<CombinedIcon> CODEC = RecordCodecBuilder.mapCodec(t -> t.group(
                ...
                CIcons.CODEC.optionalFieldOf("small", NopIcon.INSTANCE).forGetter(o -> o.small)
        ).apply(t, CombinedIcon::new));
        CIcon large;
        CIcon small;
    ...
    static class ItemIcon extends CIcon {
        ...
        ).apply(t, ItemIcon::new));
        private static final Codec<ItemIcon> ICON_CODEC =
                ForgeRegistries.ITEMS.getCodec().xmap(ItemIcon::new, t->t.stack.getItem());
        ItemStack stack;
    ...
    static class TextIcon extends CIcon {
        private static final MapCodec<TextIcon> CODEC = RecordCodecBuilder.mapCodec(t -> t.group(
                CodecUtil.COMPONENT_CODEC.fieldOf("text").forGetter(o->o.text)
        ).apply(t, TextIcon::new));
        Component text;
