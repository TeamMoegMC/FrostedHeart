...
/**
 * 盔甲装备槽，继承原版 {@link Slot}，用于在自定义菜单中显示和管理盔甲装备。
 * <p>
 * Armor equipment slot extending vanilla {@link Slot}, used to display and manage armor equipment in custom menus.
 * Handles equipment sound effects, binding curse restrictions, and displays the appropriate empty slot icon.
 */
