...
public abstract class FHBaseContainer extends AbstractContainerMenu {
	...
	public void sendMessage(int btnId,int state) {
		ChordaNetwork.sendToServer(new FHContainerOperation(this.containerId,(short) btnId,state));
	}
	public void sendMessage(int btnId,boolean state) {
		ChordaNetwork.sendToServer(new FHContainerOperation(this.containerId,(short) btnId,state?1:0));
	}
	public void sendMessage(int btnId,float state) {
		ChordaNetwork.sendToServer(new FHContainerOperation(this.containerId,(short) btnId,Float.floatToRawIntBits(state)));
	}
