...
public record FHMenuComponent<S extends IMultiblockState,C extends AbstractContainerMenu>(MultiblockContainer<S,C> cont) implements IMultiblockComponent<S> {
