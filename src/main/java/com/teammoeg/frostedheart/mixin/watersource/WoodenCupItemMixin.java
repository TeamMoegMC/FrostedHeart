...
@Mixin(WoodenCupItem.class)
public class WoodenCupItemMixin extends ItemFluidContainer {

	public WoodenCupItemMixin(Properties properties, int capacity) {
    ...
    public ICapabilityProvider initCapabilities(@Nonnull ItemStack stack, @Nullable CompoundNBT nbt)
    {
        return new FluidHandlerItemStack(stack, capacity)
        {
            ...
            {
            	if(stack.getFluid().getAttributes().isGaseous()||stack.getFluid().getAttributes().getTemperature()>427)return false;
