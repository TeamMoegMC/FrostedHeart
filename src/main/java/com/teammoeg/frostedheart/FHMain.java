...
public class FHMain {
    ...
    public FHMain() {
        ...
        FHResearch.register(new Research("coal_hand_stove", ResearchCategories.LIVING));
        FHResearch.register(new Research("snow_boots", ResearchCategories.EXPLORATION));
        FHResearch.register(new Research("steam_cannon", ResearchCategories.ARS));
        FHResearch.register(new Research("aluminum_extraction", ResearchCategories.PRODUCTION));
        FHResearch.register(new Research("generator_t1", ResearchCategories.RESCUE));
        FHResearch.register(new Research("generator_t2", ResearchCategories.RESCUE, FHResearch.getResearch("generator_t1")));
        FHResearch.register(new Research("generator_t3", ResearchCategories.RESCUE, FHResearch.getResearch("generator_t2")));
        FHResearch.register(new Research("generator_t4", ResearchCategories.RESCUE, FHResearch.getResearch("generator_t3")));
