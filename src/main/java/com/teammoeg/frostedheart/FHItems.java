...
public class FHItems {
   ...
   // public static RegistryObject<Item> wolfberries = register("wolfberries",);
    ...
    public static RegistryObject<Item> military_rations = register("military_rations",n->new CannedFoodItem( createProps().food(new Food.Builder().nutrition(6).saturationMod(0.6f).build())));
    ...
    public static RegistryObject<Item> packed_nuts = register("packed_nuts",n->new CannedFoodItem( createProps().food((new Food.Builder()).nutrition(2).saturationMod(0.8F).build()), false));
    public static RegistryObject<Item> dried_vegetables = register("dried_vegetables",n->new CannedFoodItem( createProps().food((new Food.Builder()).nutrition(4).saturationMod(0.6F).build())));
    public static RegistryObject<Item> chocolate = register("chocolate",n->new FHBaseItem( createProps().food((new Food.Builder()).nutrition(4).saturationMod(0.8F).meat().fast().build())));
