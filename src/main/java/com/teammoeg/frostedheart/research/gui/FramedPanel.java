...
public class FramedPanel extends Panel {
	...
	public void draw(MatrixStack matrixStack, Theme theme, int x, int y, int w, int h) {
		theme.drawString(matrixStack,title,x, y,DrawDeskIcons.text,0);
		DrawDeskIcons.HLINE_L.draw(matrixStack, x, y+8, 80, 3);
		DrawDeskIcons.VLINE.draw(matrixStack, x+2, y+9, 1,this.height-16);
