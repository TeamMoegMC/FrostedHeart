...
public class FHFeatures {
    ...
    public static void initFeatures() {
        ...
        ImmutableList<BlockState> clay_target = ImmutableList.of(RankineBlocks.SILTY_CLAY.get().getDefaultState(), RankineBlocks.SILTY_CLAY_MUD.get().getDefaultState(), RankineBlocks.SANDY_CLAY.get().getDefaultState(),RankineBlocks.SANDY_CLAY_MUD.get().getDefaultState(),RankineBlocks.CLAY_LOAM_MUD.get().getDefaultState());
        ...
        registerFHDisk("fh_disk_clay", Feature.DISK.withConfiguration(new SphereReplaceConfig(Blocks.CLAY.getDefaultState(), FeatureSpread.create(2, 2), 1, clay_target)).withPlacement(Features.Placements.SEAGRASS_DISK_PLACEMENT));
