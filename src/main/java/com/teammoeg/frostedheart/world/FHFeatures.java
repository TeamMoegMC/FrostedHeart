...
public class FHFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ore_anthracite = register("ore_anthracite",FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.anthracite, RankineBlocks.ANTHRACITE_ORE.get().getDefaultState(), 50)).range(80).square().chance(2));
