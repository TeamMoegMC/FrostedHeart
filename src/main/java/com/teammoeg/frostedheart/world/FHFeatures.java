...
public class FHFeatures {
    ...
    public static void initFeatures() {
        ...
        registerFHOre("ore_chalcocite", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.chalcocite, RankineBlocks.CHALCOCITE_ORE.get().getDefaultState(), 40)).range(65).square()).chance(3);
        registerFHOre("ore_malachite", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.malachite, RankineBlocks.MALACHITE_ORE.get().getDefaultState(), 45)).range(65).square().chance(3));
        ...
        registerFHOre("ore_native_tin", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.native_tin, RankineBlocks.NATIVE_TIN_ORE.get().getDefaultState(), 40)).range(65).square().chance(3));
