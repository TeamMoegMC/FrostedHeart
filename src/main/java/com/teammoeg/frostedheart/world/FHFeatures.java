...
public class FHFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ore_anthracite = register("ore_anthracite",FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.anthracite, RankineBlocks.ANTHRACITE_ORE.get().getDefaultState(), 50)).range(80).chance(15));
    public static final ConfiguredFeature<?, ?> ore_graphite = register("ore_graphite",FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.graphite, RankineBlocks.PLUMBAGO_ORE.get().getDefaultState(), 50)).range(50).chance(12));
