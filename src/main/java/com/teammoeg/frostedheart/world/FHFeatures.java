...
public class FHFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ore_galena = register("ore_galena", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.pyrite, RankineBlocks.GALENA_ORE.get().getStateContainer().getBaseState(), 40)).range(40).square().chance(5));
    public static final ConfiguredFeature<?, ?> ore_halite = register("ore_halite", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.bauxite, RankineBlocks.HALITE_ORE.get().getStateContainer().getBaseState(), 40)).range(65).square().chance(5));
    public static final ConfiguredFeature<?, ?> ore_fluorite = register("ore_fluorite", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.gold, RankineBlocks.FLUORITE_ORE.get().getStateContainer().getBaseState(), 35)).range(65).square().chance(8));
    public static final ConfiguredFeature<?, ?> ore_vanadinite = register("ore_vanadinite", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.pyrite, RankineBlocks.VANADINITE_ORE.get().getStateContainer().getBaseState(), 30)).range(65).square().chance(8));
    public static final ConfiguredFeature<?, ?> ore_silver = register("ore_silver", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.gold, RankineBlocks.NATIVE_SILVER_ORE.get().getStateContainer().getBaseState(), 35)).range(30).square().chance(10));
    public static final ConfiguredFeature<?, ?> ore_gold = register("ore_gold", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.gold, RankineBlocks.NATIVE_GOLD_ORE.get().getStateContainer().getBaseState(), 35)).range(30).square().chance(10));
