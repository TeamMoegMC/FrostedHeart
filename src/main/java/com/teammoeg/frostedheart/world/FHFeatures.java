...
public class FHFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ore_pentlandite = register("ore_pentlandite", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.pentlandite, RankineBlocks.PENTLANDITE_ORE.get().getStateContainer().getBaseState(), 40)).range(65).square().chance(6));
