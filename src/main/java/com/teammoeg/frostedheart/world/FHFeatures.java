...
public class FHFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ore_pyrite = register("ore_pyrite", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.pyrite, RankineBlocks.PYRITE_ORE.get().getDefaultState(), 40)).range(35).square().chance(5));
    public static final ConfiguredFeature<?, ?> ore_hematite = register("ore_hematite", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.hematite, RankineBlocks.HEMATITE_ORE.get().getDefaultState(), 40)).range(35).square().chance(5));
    public static final ConfiguredFeature<?, ?> ore_chalcocite = register("ore_chalcocite", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.chalcocite, RankineBlocks.CHALCOCITE_ORE.get().getDefaultState(), 40)).range(65).square()).chance(2);
    ...
    public static final ConfiguredFeature<?, ?> ore_fluorite = register("ore_fluorite", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.gold, FHContent.FHBlocks.fluorite_ore.getDefaultState(), 35)).range(65).square().chance(10));
    ...
    public static final ConfiguredFeature<?, ?> copper_gravel = Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, "copper_gravel" ,Feature.DISK.withConfiguration(new SphereReplaceConfig(FHContent.FHBlocks.copper_gravel.getDefaultState(), FeatureSpread.create(1, 1), 1, ImmutableList.of(Blocks.GRAVEL.getDefaultState(),RankineBlocks.ALLUVIUM.get().getDefaultState(),Blocks.SAND.getDefaultState(),Blocks.DIRT.getDefaultState()))).withPlacement(Features.Placements.SEAGRASS_DISK_PLACEMENT).chance(2));
    public static final ConfiguredFeature<?, ?> clay = Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, "clay" ,Feature.DISK.withConfiguration(new SphereReplaceConfig(Blocks.CLAY.getDefaultState(), FeatureSpread.create(1, 1), 1, ImmutableList.of(RankineBlocks.SANDY_CLAY.get().getDefaultState(),RankineBlocks.SILTY_CLAY.get().getDefaultState()))).withPlacement(Features.Placements.SEAGRASS_DISK_PLACEMENT).chance(1));
