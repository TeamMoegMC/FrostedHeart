...
public class FHFeatures {
    ...
    public static final ConfiguredFeature<?, ?> ore_magnesite = register("ore_magnesite", FHORE.withConfiguration(new FHOreFeatureConfig(FHOreFeatureConfig.FillerBlockType.bituminous, RankineBlocks.MAGNESITE_ORE.get().getStateContainer().getBaseState(), 40)).range(65).square().chance(8));
