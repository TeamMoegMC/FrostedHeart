...
import com.teammoeg.frostedheart.world.biome.RelicBiome;
...
public class FHBiomes {
    ...
    public static RegistryObject<Biome> RELIC = BIOME_REGISTER.register("relic", () -> new RelicBiome().build());
    ...
    public static void Biomes(){
        BiomeManager.addBiome(BiomeManager.BiomeType.COOL, new BiomeManager.BiomeEntry(makeKey(VOLCANIC.get()), 50));
    }
}
