...
public class FHOreFeatureConfig implements IFeatureConfig {
    ...
    public static final class FillerBlockType {
        ...
        public static final FHRuleTest pentlandite = new FHRuleTest(new Block[]{RankineBlocks.THOLEIITIC_BASALT.get(), RankineBlocks.GRAY_GRANITE.get(), Blocks.DIORITE, Blocks.GRANITE, RankineBlocks.RHYOLITE.get(), RankineBlocks.PYROXENE_GABBRO.get(), RankineBlocks.GRANODIORITE.get(), RankineBlocks.KOMATIITE.get()});
        public static final FHRuleTest native_tin = new FHRuleTest(new Block[]{RankineBlocks.PEGMATITE.get(), RankineBlocks.RHYOLITE.get(), RankineBlocks.QUARTZITE.get(), RankineBlocks.QUARTZ_SANDSTONE.get(),Blocks.ANDESITE});
        ...
        public static final FHRuleTest bituminous = new FHRuleTest(new Block[]{RankineBlocks.DOLOSTONE.get(), RankineBlocks.CHALK.get(), RankineBlocks.CARBONACEOUS_SHALE.get(), RankineBlocks.TUFA_LIMESTONE.get(), RankineBlocks.MUDSTONE.get()});
        ...
        public static final FHRuleTest bauxite = new FHRuleTest(new Block[]{RankineBlocks.TUFA_LIMESTONE.get(), RankineBlocks.MUDSTONE.get(), RankineBlocks.CHALK.get(), RankineBlocks.CARBONACEOUS_SHALE.get(), RankineBlocks.DOLOSTONE.get()});
        ...
        public static final FHRuleTest anthracite = new FHRuleTest(new Block[]{RankineBlocks.WHITE_MARBLE.get(), RankineBlocks.SLATE.get(), RankineBlocks.CARBONACEOUS_SHALE.get()});
