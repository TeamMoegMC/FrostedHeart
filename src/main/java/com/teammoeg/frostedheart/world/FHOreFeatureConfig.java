...
public class FHOreFeatureConfig implements IFeatureConfig {
    ...
    public static final class FillerBlockType {
        ...
        public static final FHRuleTest bituminous = new FHRuleTest(new Block[]{RankineBlocks.CHALK.get(), RankineBlocks.CARBONACEOUS_SHALE.get(), RankineBlocks.TUFA_LIMESTONE.get(), RankineBlocks.MUDSTONE.get()});
