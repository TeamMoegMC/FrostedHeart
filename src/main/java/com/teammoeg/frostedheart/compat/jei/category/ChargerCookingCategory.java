...
public class ChargerCookingCategory implements IRecipeCategory<SmokingRecipe> {
    ...
    @Override
    public void draw(SmokingRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics transform, double mouseX, double mouseY) {
    ...
    public void setRecipe(IRecipeLayoutBuilder iRecipeLayoutBuilder, SmokingRecipe smokingRecipe, IFocusGroup iFocusGroup) {
        ...
        iRecipeLayoutBuilder.addSlot(RecipeIngredientRole.INPUT, 16, 26).addIngredients(smokingRecipe.getIngredients().get(0));
        iRecipeLayoutBuilder.addSlot(RecipeIngredientRole.OUTPUT, 151, 44).addItemStack(smokingRecipe.getResultItem(null));

    }

    @Override
    public RecipeType<SmokingRecipe> getRecipeType() {
        return JEICompat.ChargerCooking;
    }
