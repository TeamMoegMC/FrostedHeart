...
public class SmokingDefrostCategory implements IRecipeCategory<SmokingDefrostRecipe> {
    ...
    @Override
    public void draw(SmokingDefrostRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics transform, double mouseX, double mouseY) {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder iRecipeLayoutBuilder, SmokingDefrostRecipe smokingDefrostRecipe, IFocusGroup iFocusGroup) {
        iRecipeLayoutBuilder.addSlot(RecipeIngredientRole.INPUT, 0, 0).addIngredients(Ingredient.merge(smokingDefrostRecipe.getIngredients()));
        iRecipeLayoutBuilder.addSlot(RecipeIngredientRole.OUTPUT, 60, 8).addItemStack(smokingDefrostRecipe.getResultItem(null));
    }

    @Override
    public RecipeType<SmokingDefrostRecipe> getRecipeType() {
        return JEICompat.SmokingDefrost;
    }
