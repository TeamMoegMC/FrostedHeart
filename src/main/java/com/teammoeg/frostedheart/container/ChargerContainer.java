...
public class ChargerContainer extends IEBaseContainer<ChargerTileEntity> {

    public ChargerContainer(int id, PlayerInventory inventoryPlayer, ChargerTileEntity tile) {
