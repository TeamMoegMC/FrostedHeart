...
public class FHBlocks {
    ...
    public static Block rye_block = new RyeBlock("rye_block", WorldClimate.COLD_RESIST_GROW_TEMPERATURE, cropProps, FHBlockItem::new);
    public static Block wolfberry_bush_block = new WolfBerryBushBlock("wolfberry_bush_block",WorldClimate.COLD_RESIST_GROW_TEMPERATURE, berryBushBlocks, 10);
    public static Block white_turnip_block = new WhiteTurnipBlock("white_turnip_block", WorldClimate.COLD_RESIST_GROW_TEMPERATURE, cropProps, ((block, properties) -> new FoodBlockItem(block, properties, FHFoods.WHITE_TURNIP)));
