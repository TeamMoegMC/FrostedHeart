...
public class SourceOnlyFluidBuilder<T extends ForgeFlowingFluid, P> extends AbstractBuilder<Fluid, T, P, SourceOnlyFluidBuilder<T, P>> {
    ...
    /**
     * Create a new {@link SourceOnlyFluidBuilder} and configure data. The created builder will use a default ({@link FluidType}) and fluid class ({@link ForgeFlowingFluid.Flowing}).
     *
     * @param <P>
     *            Parent object type
     * @param owner
     ...
     * @return A new {@link SourceOnlyFluidBuilder} with reasonable default data generators.
     ...
     */
    public static <P> SourceOnlyFluidBuilder<ForgeFlowingFluid.Flowing, P> create(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture) {
        return create(owner, parent, name, callback, stillTexture, flowingTexture, SourceOnlyFluidBuilder::defaultFluidType, ForgeFlowingFluid.Flowing::new);
    }

    /**
     * Create a new {@link SourceOnlyFluidBuilder} and configure data. The created builder will use a default fluid class ({@link ForgeFlowingFluid.Flowing}).
     *
     * @param <P>
     *            Parent object type
     * @param owner
     ...
     * @see #create(AbstractRegistrate, Object, String, BuilderCallback, ResourceLocation, ResourceLocation, FluidTypeFactory, NonNullFunction)
     */
    public static <P> SourceOnlyFluidBuilder<ForgeFlowingFluid.Flowing, P> create(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture, FluidTypeFactory typeFactory) {
     ...
     * @see #create(AbstractRegistrate, Object, String, BuilderCallback, ResourceLocation, ResourceLocation, FluidTypeFactory, NonNullFunction)
     */
    public static <P> SourceOnlyFluidBuilder<ForgeFlowingFluid.Flowing, P> create(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture, NonNullSupplier<FluidType> fluidType) {
     ...
     * @return A new {@link SourceOnlyFluidBuilder} with reasonable default data generators.
     */
    public static <T extends ForgeFlowingFluid, P> SourceOnlyFluidBuilder<T, P> create(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture,
        NonNullFunction<ForgeFlowingFluid.Properties, T> fluidFactory) {
        return create(owner, parent, name, callback, stillTexture, flowingTexture, SourceOnlyFluidBuilder::defaultFluidType, fluidFactory);
    }

    /**
     * Create a new {@link SourceOnlyFluidBuilder} and configure data. Used in lieu of adding side-effects to constructor, so that alternate initialization strategies can be done in subclasses.
     * <p>
    ...
    public static <T extends ForgeFlowingFluid, P> SourceOnlyFluidBuilder<T, P> create(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture,
        ...
        SourceOnlyFluidBuilder<T, P> ret = new SourceOnlyFluidBuilder<>(owner, parent, name, callback, stillTexture, flowingTexture, typeFactory, fluidFactory)
    ...
    public static <T extends ForgeFlowingFluid, P> SourceOnlyFluidBuilder<T, P> create(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture,
        ...
        SourceOnlyFluidBuilder<T, P> ret = new SourceOnlyFluidBuilder<>(owner, parent, name, callback, stillTexture, flowingTexture, fluidType, fluidFactory)
                .defaultLang().defaultBlock().defaultBucket();
        return ret;
    }
    ...
    public SourceOnlyFluidBuilder(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture, FluidTypeFactory typeFactory, NonNullFunction<ForgeFlowingFluid.Properties, T> fluidFactory) {
    ...
    public SourceOnlyFluidBuilder(AbstractRegistrate<?> owner, P parent, String name, BuilderCallback callback, ResourceLocation stillTexture, ResourceLocation flowingTexture, NonNullSupplier<FluidType> fluidType, NonNullFunction<ForgeFlowingFluid.Properties, T> fluidFactory) {
        super(owner, parent, name, callback, ForgeRegistries.Keys.FLUIDS);
        this.bucketName = name + "_bucket";
        this.stillTexture = stillTexture;
        this.flowingTexture = flowingTexture;
     ...
     */
    public SourceOnlyFluidBuilder<T, P> properties(NonNullConsumer<FluidType.Properties> cons) {
     ...
     * @return this {@link SourceOnlyFluidBuilder}
     */
    public SourceOnlyFluidBuilder<T, P> fluidProperties(NonNullConsumer<ForgeFlowingFluid.Properties> cons) {
     ...
     * @return this {@link SourceOnlyFluidBuilder}
     */
    public SourceOnlyFluidBuilder<T, P> defaultLang() {
     ...
     * @return this {@link SourceOnlyFluidBuilder}
     */
    public SourceOnlyFluidBuilder<T, P> lang(String name) {
        return lang(f -> f.getFluidType().getDescriptionId(), name);
    }

    @SuppressWarnings("deprecation")
    public SourceOnlyFluidBuilder<T, P> renderType(Supplier<RenderType> layer) {
     ...
     */
    public SourceOnlyFluidBuilder<T, P> defaultBlock() {
     ...
     */
    public BlockBuilder<LiquidBlock, SourceOnlyFluidBuilder<T, P>> block() {
     ...
     * @return the {@link BlockBuilder} for the {@link LiquidBlock}
     */
    public <B extends LiquidBlock> BlockBuilder<B, SourceOnlyFluidBuilder<T, P>> block(NonNullBiFunction<NonNullSupplier<? extends T>, BlockBehaviour.Properties, ? extends B> factory) {
        if (this.defaultBlock == Boolean.FALSE) {
            throw new IllegalStateException("Only one call to block/noBlock per builder allowed");
        }
        this.defaultBlock = false;
        NonNullSupplier<T> supplier = asSupplier();
        return getOwner().<B, SourceOnlyFluidBuilder<T, P>>block(this, getName(), p -> factory.apply(supplier, p))
    ...
    @Beta
    public SourceOnlyFluidBuilder<T, P> noBlock() {
        if (this.defaultBlock == Boolean.FALSE) {
            throw new IllegalStateException("Only one call to block/noBlock per builder allowed");
        }
        this.defaultBlock = false;
     ...
     */
    public SourceOnlyFluidBuilder<T, P> defaultBucket() {
     ...
     */
    public ItemBuilder<BucketItem, SourceOnlyFluidBuilder<T, P>> bucket() {
     ...
     * @return the {@link ItemBuilder} for the {@link BucketItem}
     */
    public <I extends BucketItem> ItemBuilder<I, SourceOnlyFluidBuilder<T, P>> bucket(NonNullBiFunction<Supplier<? extends ForgeFlowingFluid>, Item.Properties, ? extends I> factory) {
        if (this.defaultBucket == Boolean.FALSE) {
            throw new IllegalStateException("Only one call to bucket/noBucket per builder allowed");
        }
        this.defaultBucket = false;
        NonNullSupplier<? extends ForgeFlowingFluid> source = this.asSupplier();
        ...
        return getOwner().<I, SourceOnlyFluidBuilder<T, P>>item(this, bucketName, p -> factory.apply(source::get, p))
            .properties(p -> p.craftRemainder(Items.BUCKET).stacksTo(1))
            .model((ctx, prov) -> prov.generated(ctx::getEntry, new ResourceLocation(getOwner().getModid(), "item/" + bucketName)));
    }

    @Beta
    public SourceOnlyFluidBuilder<T, P> noBucket() {
        if (this.defaultBucket == Boolean.FALSE) {
            throw new IllegalStateException("Only one call to bucket/noBucket per builder allowed");
        }
        this.defaultBucket = false;
     ...
     */
    @SafeVarargs
    public final SourceOnlyFluidBuilder<T, P> removeTag(TagKey<Fluid>... tags) {
    ...
    public FluidEntry<T> register() {
        ...
        if (this.fluidType != null) {
            ...
            if (this.registerType) {
                getOwner().simple(this, this.getName(), ForgeRegistries.Keys.FLUID_TYPES, this.fluidType);
            }
        } else {
    ...
    private ForgeFlowingFluid getSource() {
        NonNullSupplier<? extends ForgeFlowingFluid> source = this.asSupplier();
        Preconditions.checkNotNull(source, "Fluid has no source block: " + getName());
        return source.get();
    }
    @Override
