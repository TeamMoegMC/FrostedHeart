...
public class DefaultValueMapCodec<A> extends MapCodec<A> {
    private final String name;
    private final Codec<A> elementCodec;
    private final Supplier<A> defVal;
    public DefaultValueMapCodec(final String name, final Codec<A> elementCodec, final Supplier<A> defaultValue) {
        this.name = name;
    ...
    public boolean equals(final Object o) {
        ...
        final DefaultValueMapCodec<?> that = (DefaultValueMapCodec<?>) o;
