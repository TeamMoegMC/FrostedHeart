...
public interface ITownResourceAttribute {
    ...
    /**
     * Create a new town resource attribute of given type and level.
     * Can accept interface ITownResourceType.
     */
    static ITownResourceAttribute of(ITownResourceType type, int level){
        return type.generateAttribute(level);
    }
}
