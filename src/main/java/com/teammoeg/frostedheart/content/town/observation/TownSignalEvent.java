...
public record TownSignalEvent(
    ...
    public enum Type {
        ...
        EXIT_RISK_ENTERED,
        EXIT_RISK_RECOVERED,
        NUTRITION_FAT_SEVERE,
        NUTRITION_FAT_RECOVERED,
        NUTRITION_CARBOHYDRATE_SEVERE,
        NUTRITION_CARBOHYDRATE_RECOVERED,
        NUTRITION_PROTEIN_SEVERE,
        NUTRITION_PROTEIN_RECOVERED,
        NUTRITION_VEGETABLE_SEVERE,
