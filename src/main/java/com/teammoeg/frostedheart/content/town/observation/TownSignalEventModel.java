...
public final class TownSignalEventModel {
    ...
    public static TownSignalEvent.Severity defaultSeverity(TownSignalEvent.Type type) {
        return switch (type) {
            case CLIMATE_COLD_ENDED, TOWER_SERVICE_RESTORED,
                    ...
                    EXIT_RISK_RECOVERED, NUTRITION_FAT_RECOVERED,
                    NUTRITION_CARBOHYDRATE_RECOVERED, NUTRITION_PROTEIN_RECOVERED,
                    NUTRITION_VEGETABLE_RECOVERED,
            ...
            case TOWER_SERVICE_LOST, HOUSE_TEMPERATURE_UNSAFE,
                    ...
                    EXIT_RISK_ENTERED, NUTRITION_FAT_SEVERE,
                    NUTRITION_CARBOHYDRATE_SEVERE, NUTRITION_PROTEIN_SEVERE,
                    NUTRITION_VEGETABLE_SEVERE -> TownSignalEvent.Severity.CRITICAL;
    ...
    private static Domain domain(TownSignalEvent.Type type) {
        return switch (type) {
            ...
            case NUTRITION_FAT_SEVERE, NUTRITION_FAT_RECOVERED -> Domain.NUTRITION_FAT;
            case NUTRITION_CARBOHYDRATE_SEVERE, NUTRITION_CARBOHYDRATE_RECOVERED ->
                    Domain.NUTRITION_CARBOHYDRATE;
            case NUTRITION_PROTEIN_SEVERE, NUTRITION_PROTEIN_RECOVERED -> Domain.NUTRITION_PROTEIN;
            case NUTRITION_VEGETABLE_SEVERE, NUTRITION_VEGETABLE_RECOVERED ->
                    Domain.NUTRITION_VEGETABLE;
