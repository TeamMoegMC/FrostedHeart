...
public class TownResourceActionResults {
    ...
    public static record ItemResourceAttributeCostActionResult(
            TownResourceActions.ItemResourceAttributeCostAction action, boolean allModified, double totalModifiedAmount, double residualAmount, Map<ItemStackResourceKey, Double> details)
            implements ITownResourceAttributeActionResult<TownResourceActions.ItemResourceAttributeCostAction> {
        @Override
     ...
     */
    public record ItemStackActionResult(TownResourceActions.ItemStackAction action, Boolean allModified, ItemStack itemStackModified, ItemStack itemStackLeft)
            implements ITownResourceActionResult<TownResourceActions.ItemStackAction> {
        @Override
     ...
     */
    public record TownResourceTypeCostActionResult(TownResourceActions.TownResourceTypeCostAction action, boolean allCosted, double totalModifiedAmount, double residualAmount, List<ITownResourceAttributeActionResult<?>> details)
            implements ITownResourceActionResult<TownResourceActions.TownResourceTypeCostAction> {
    ...
    public record GetActionResult(TownResourceActions.GetAction action, double amount)
            implements ITownResourceActionResult<TownResourceActions.GetAction> {
        @Override
     ...
     */
    public record VirtualResourceAttributeActionResult(TownResourceActions.VirtualResourceAttributeAction action, boolean allModified, double modifiedAmount, double residualAmount )
            implements ITownResourceAttributeActionResult<TownResourceActions.VirtualResourceAttributeAction> {
