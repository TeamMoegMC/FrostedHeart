...
public class DebugScreen extends Screen {
    ...
    public void init() {
        ...
        this.addButton(new IconButton((int) (this.width*0.5+15), (int) (this.height*0.4), IconButton.ICON_BOX_ON, 0xFFC6FCFF, new TextComponent("Add a random waypoint"), (b) -> {
        ...
        this.addButton(new IconButton((int) (this.width*0.5+35), (int) (this.height*0.4), IconButton.ICON_BOX, 0xFFFF5340, new TextComponent("Remove all waypoint"), (b) -> {
