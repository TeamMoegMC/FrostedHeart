...
public class FHIcons {
    ...
    public static abstract class IconEditor<T extends FHIcon> extends BaseEditDialog {
        ...
        public static final Editor<FHIngredientIcon> INGREDIENT_EDITOR = (p, l, v, c) -> IngredientEditor.EDITOR_INGREDIENT_EXTERN.open(p, l, v == null ? null : v.igd,
                e -> c.accept(new FHIngredientIcon(e)));        public static final Editor<FHIcon> EDITOR = (p, l, v, c) -> {
        ...
        public static final Editor<FHIcon> INGREDIENT_SIZE_EDITOR = (p, l, v, c) -> IngredientEditor.EDITOR.open(p, l, null, e -> c.accept(FHIcons.getIcon(e)));        public static final Editor<FHIcon> CHANGE_EDITOR = (p, l, v, c) -> {
