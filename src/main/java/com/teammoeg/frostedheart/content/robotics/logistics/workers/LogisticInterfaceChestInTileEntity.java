...
public class LogisticInterfaceChestInTileEntity extends CBlockEntity implements CTickableBlockEntity,MenuProvider,ILogisticProvider,LogisticStatusBlockEntity {
	@Getter
	LogisticInterfaceChestInGrid container;
	...
	public LogisticInterfaceChestInTileEntity(BlockPos pos,BlockState bs) {
		super(FHBlockEntityTypes.LOGISTIC_INTERFACE_CHEST_IN.get(),pos,bs);
		container=new LogisticInterfaceChestInGrid(null,pos,this::setChanged);
	}
	...
	public AbstractContainerMenu createMenu(int pContainerId, Inventory pPlayerInventory, Player pPlayer) {
		return new LogisticInterfaceChestInMenu(pContainerId,this,pPlayerInventory,container);
	}
	@Override
