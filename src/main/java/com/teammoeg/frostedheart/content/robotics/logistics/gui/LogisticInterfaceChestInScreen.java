...
public class LogisticInterfaceChestInScreen extends LogisticChestLayer<LogisticInterfaceChestInMenu> {


	public LogisticInterfaceChestInScreen(LogisticInterfaceChestInMenu container) {
		super(container);
	}
	@Override
