...
public class GraphicsTextContent extends GraphicLayerContent {
	...
	public void prerender(PrerenderParams params) {
		...
		RenderComponentsUtil.wrapComponents(text,(int) (r.getW()/(size/7f)), Minecraft.getInstance().font).get(0).accept(new GraphicGlyphRenderer(params.getG2d(),params.calculateScaledX(x),params.calculateScaledY(y),size,shadow));
