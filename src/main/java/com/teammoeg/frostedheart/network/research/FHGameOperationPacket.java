...
public class FHGameOperationPacket {
    private final BlockPos pos;
    private final byte op;
    private final CardPos pos1;
    private final CardPos pos2;
    
    protected FHGameOperationPacket(BlockPos pos, int op, CardPos pos1, CardPos pos2) {
		super();
		this.pos = pos;
		this.op = (byte) op;
		this.pos1 = pos1;
	...
	public FHGameOperationPacket(BlockPos pos,CardPos p1,CardPos p2) {
		this(pos,2,p1,p2);
    }
    public FHGameOperationPacket(BlockPos pos,CardPos p1) {
    	this(pos,1,p1,null);
    }
    public FHGameOperationPacket(BlockPos pos) {
        this(pos,0,null,null);
        
    }
    public FHGameOperationPacket(PacketBuffer buffer) {
