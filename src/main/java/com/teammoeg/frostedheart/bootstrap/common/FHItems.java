...
thinner.png
    ...
    public static final ItemEntry<Item> ANTIFREEZE =
            taggedIngredient("antifreeze",
                    FHTags.Items.GARBAGE.tag);
    public static final ItemEntry<Item> CABLE =
            taggedIngredient("cable",
                    FHTags.Items.GARBAGE.tag,
                    FHTags.Items.IGNITION_METAL.tag);
    public static final ItemEntry<Item> DEFLECTION_COIL =
            taggedIngredient("deflection_coil",
                    FHTags.Items.GARBAGE.tag,
                    FHTags.Items.IGNITION_METAL.tag);
    public static final ItemEntry<Item> ENGINE_OIL =
            taggedIngredient("engine_oil",
                    FHTags.Items.GARBAGE.tag);
    public static final ItemEntry<Item> FERROCERIUM_FIRE_STARTER =
            taggedIngredient("ferrocerium_fire_starter",
                    FHTags.Items.GARBAGE.tag,
                    FHTags.Items.IGNITION_METAL.tag);
    public static final ItemEntry<Item> INSULATOR =
            taggedIngredient("insulator",
                    FHTags.Items.GARBAGE.tag,
                    FHTags.Items.IGNITION_METAL.tag);
    public static final ItemEntry<Item> IRON_FENCE_REMAINS =
            taggedIngredient("iron_fence_remains",
                    FHTags.Items.GARBAGE.tag,
                    FHTags.Items.IGNITION_METAL.tag);
    public static final ItemEntry<Item> IRON_PARTS =
            taggedIngredient("iron_parts",
                    FHTags.Items.GARBAGE.tag,
                    FHTags.Items.IGNITION_METAL.tag);
    public static final ItemEntry<Item> IRON_PLATING =
            taggedIngredient("iron_plating",
                    FHTags.Items.GARBAGE.tag,
                    FHTags.Items.IGNITION_METAL.tag);
    public static final ItemEntry<Item> IRON_TRUSS_REMAINS =
            taggedIngredient("iron_truss_remains",
                    FHTags.Items.GARBAGE.tag,
                    FHTags.Items.IGNITION_METAL.tag);
    public static final ItemEntry<Item> LEAD_ACID_BATTERY =
            taggedIngredient("lead_acid_battery", FHTags.Items.GARBAGE.tag);
    public static final ItemEntry<Item> MOLY_LUBRICANT =
            taggedIngredient("moly_lubricant", FHTags.Items.GARBAGE.tag);
    public static final ItemEntry<Item> RUST_REMOVER =
            taggedIngredient("rust_remover", FHTags.Items.GARBAGE.tag);
    public static final ItemEntry<Item> SILICONE_GREASE =
    ...
    public static final ItemEntry<Item> THINNER =
    ...
    // ice_chips
    public static final ItemEntry<FHSnowballItem> ICE_CHIP =
            REGISTRATE.item("ice_chip", FHSnowballItem::new)
                    .tag(forgeItemTag("raw_materials/ice"))
                    .register();
    // Soil drops
    public static final ItemEntry<Item> PEAT =
    ...
    public static final ItemEntry<Item> KAOLIN =
...
//            );
    ...
    public static final ItemEntry<Item> CONSTANTAN_INGOT =
            taggedIngredient("constantan_ingot",
                    forgeItemTag("ingots"),
                    forgeItemTag("ingots/constantan")
            );
//    public static final ItemEntry<Item> IRON_INGOT =
...
//            );
    public static final ItemEntry<Item> DURALUMIN_INGOT =
            taggedIngredient("duralumin_ingot",
                    forgeItemTag("ingots"),
                    forgeItemTag("ingots/duralumin"),
                    FHTags.Items.IGNITION_METAL.tag
            );
//    public static final ItemEntry<Item> GOLD_INGOT =
...
//            );
    ...
    public static final ItemEntry<Item> INVAR_INGOT =
            taggedIngredient("invar_ingot",
                    forgeItemTag("ingots"),
                    forgeItemTag("ingots/invar")
            );
    public static final ItemEntry<Item> TUNGSTEN_STEEL_INGOT =
...
//            );
    ...
    public static final ItemEntry<Item> CONSTANTAN_NUGGET =
            taggedIngredient("constantan_nugget",
                    forgeItemTag("nuggets"),
                    forgeItemTag("nuggets/constantan")
            );
//    public static final ItemEntry<Item> IRON_NUGGET =
...
//            );
    public static final ItemEntry<Item> DURALUMIN_NUGGET =
            taggedIngredient("duralumin_nugget",
                    forgeItemTag("nuggets"),
                    forgeItemTag("nuggets/duralumin"),
                    FHTags.Items.IGNITION_METAL.tag
            );
//    public static final ItemEntry<Item> GOLD_NUGGET =
...
//            );
    ...
    public static final ItemEntry<Item> INVAR_NUGGET =
            taggedIngredient("invar_nugget",
                    forgeItemTag("nuggets"),
                    forgeItemTag("nuggets/invar")
            );
    public static final ItemEntry<Item> TUNGSTEN_STEEL_NUGGET =
...
//            );
    ...
    public static final ItemEntry<Item> CONSTANTAN_SHEET =
...
//            );
    public static final ItemEntry<Item> DURALUMIN_SHEET =
...
//    public static final ItemEntry<Item> GOLD_SHEET =
...
//            );
    ...
    public static final ItemEntry<Item> INVAR_SHEET =
    ...
    public static final ItemEntry<Item> TUNGSTEN_STEEL_SHEET =
    ...
    public static final ItemEntry<Item> ALUMINUM_ROD =
            taggedIngredient("aluminum_rod",
                    forgeItemTag("rods"),
                    forgeItemTag("rods/aluminum")
            );
    public static final ItemEntry<Item> STEEL_ROD =
    ...
    public static final ItemEntry<Item> CONSTANTAN_ROD =
    ...
    public static final ItemEntry<Item> CAST_IRON_ROD =
    ...
    public static final ItemEntry<Item> STEEL_WIRE =
    ...
    public static final ItemEntry<Item> CONSTANTAN_WIRE =
    ...
    // Rusted ingots
    public static final ItemEntry<Item> RUSTED_IRON_INGOT = REGISTRATE
    ...
    // Slags
    public static final ItemEntry<Item> IRON_SLAG =
            taggedIngredient("iron_slag",
                    forgeItemTag("slags"),
                    forgeItemTag("slags/iron")
            );
    public static final ItemEntry<Item> NICKEL_MATTE =
    ...
    // Misc
    public static final ItemEntry<Item> MORTAR =
            ingredient("mortar");
    public static final ItemEntry<Item> VULCANIZED_RUBBER =
            taggedIngredient("vulcanized_rubber",
                    forgeItemTag("rubber")
            );
    public static final ItemEntry<Item> PULP =
            ingredient("pulp");
    public static final ItemEntry<Item> FIRE_CLAY_BALL =
            ingredient("fire_clay_ball");
    public static final ItemEntry<Item> HIGH_REFRACTORY_BRICK =
            ingredient("high_refractory_brick");
    public static final ItemEntry<Item> SAWDUST =
            taggedIngredient("sawdust",
                    forgeItemTag("dusts/wooden"),
                    forgeItemTag("dusts/wood"),
                    CPTags.Items.COOKABLE
            );
    public static final ItemEntry<Item> BIOMASS = REGISTRATE
            .item("biomass", Item::new)
            .register();
    public static final ItemEntry<Item> dung = REGISTRATE
            .item("dung", Item::new)
            .register();
    public static final ItemEntry<Item> night_soil = REGISTRATE
    ...
    public static final ItemEntry<Item> REFRACTORY_BRICK =
            ingredient("refractory_brick");
    public static final ItemEntry<Item> FLUX =
            ingredient("flux");

    public static final ItemEntry<Item> generator_ash = REGISTRATE
            .item("generator_ash", Item::new)
            .model(FHBlockStateGen.existingItemModel())
            .register();
    public static final ItemEntry<Item> raw_hide = REGISTRATE
            .item("raw_hide", Item::new)
            .model(FHBlockStateGen.existingItemModel())
            .register();
    public static final ItemEntry<Item> fox_hide = REGISTRATE
            .item("fox_hide", Item::new)
            .register();
    public static final ItemEntry<Item> wolf_hide = REGISTRATE
            .item("wolf_hide", Item::new)
            .register();
    public static final ItemEntry<Item> polar_bear_hide = REGISTRATE
            .item("polar_bear_hide", Item::new)
            .register();
    public static final ItemEntry<Item> makeshift_core_broken = REGISTRATE
            .item("makeshift_core_broken", Item::new)
            .model(FHBlockStateGen.existingItemModel())
            .lang("Broken Makeshift Core")
            .register();
    public static final ItemEntry<Item> handheld_core = REGISTRATE
            .item("handheld_core", Item::new)
            .model(FHBlockStateGen.existingItemModel())
            .lang("Repaired Makeshift Core")
            .register();
    public static final ItemEntry<Item> energy_core = REGISTRATE
    ...
    // Foods and plants
    public static final ItemEntry<Item> dried_wolfberries = REGISTRATE
            .item("dried_wolfberries", Item::new)
            .tag(FHTags.Items.WOLFBERRIES.tag)
            .model(FHBlockStateGen.existingItemModel())
            .properties(p -> p.food(FHFoodProperties.DRIED_WOLFBERRIES))
            .register();
    public static final ItemEntry<Item> rye = REGISTRATE
            .item("rye", Item::new)
            .model(FHBlockStateGen.existingItemModel())
            .register();
    public static final ItemEntry<Item> INULIN = REGISTRATE
            .item("inulin", Item::new)
            .register();
    public static final ItemEntry<Item> frozen_seeds = REGISTRATE
            .item("frozen_seeds", Item::new)
            .model(FHBlockStateGen.existingItemModel())
            .register();
    public static final ItemEntry<Item> rye_flour = REGISTRATE
            .item("rye_flour", Item::new)
            .model(FHBlockStateGen.existingItemModel())
            .register();
    public static final ItemEntry<Item> raw_rye_bread = REGISTRATE
            .item("raw_rye_bread", Item::new)
            .model(FHBlockStateGen.existingItemModel())
            .lang("Rye Dough")
            .register();
    public static final ItemEntry<Item> random_seeds = REGISTRATE
            .item("random_seeds", Item::new)
            .model(FHBlockStateGen.existingItemModel())
            .register();
    public static final ItemEntry<Item> rye_bread = REGISTRATE
            ...
            .register();
    public static final ItemEntry<Item> black_bread = REGISTRATE
            .item("black_bread", Item::new)
            .tag(FHTags.Items.REFUGEE_NEEDS.tag)
            .model(FHBlockStateGen.existingItemModel())
            .properties(p -> p.food(FHFoodProperties.BLACK_BREAD))
            .register();
    public static final ItemEntry<FHSoupItem> vegetable_sawdust_soup = REGISTRATE
            .item("vegetable_sawdust_soup", FHSoupItem::new)
            .tag(FHTags.Items.REFUGEE_NEEDS.tag)
            .model(FHBlockStateGen.existingItemModel())
            .properties(p -> p.stacksTo(1).food(FHFoodProperties.VEGETABLE_SAWDUST_SOUP))
            .register();
    public static final ItemEntry<FHSoupItem> rye_sawdust_porridge = REGISTRATE
            .item("rye_sawdust_porridge", FHSoupItem::new)
            .tag(FHTags.Items.REFUGEE_NEEDS.tag)
            .model(FHBlockStateGen.existingItemModel())
            .properties(p -> p.stacksTo(1).food(FHFoodProperties.RYE_SAWDUST_PORRIDGE))
            .register();
    public static final ItemEntry<FHSoupItem> rye_porridge = REGISTRATE
            .item("rye_porridge", FHSoupItem::new)
            .tag(FHTags.Items.REFUGEE_NEEDS.tag)
            .model(FHBlockStateGen.existingItemModel())
            .properties(p -> p.stacksTo(1).food(FHFoodProperties.RYE_SAWDUST_PORRIDGE))
            .register();
    public static final ItemEntry<FHSoupItem> vegetable_soup = REGISTRATE
            .item("vegetable_soup", FHSoupItem::new)
            .tag(FHTags.Items.REFUGEE_NEEDS.tag)
            .model(FHBlockStateGen.existingItemModel())
            .properties(p -> p.stacksTo(1).food(FHFoodProperties.VEGETABLE_SAWDUST_SOUP))
            .register();
    public static final ItemEntry<CannedFoodItem> military_rations = REGISTRATE
            ...
            .register();
    public static final ItemEntry<CannedFoodItem> compressed_biscuits_pack = REGISTRATE
            ...
            .register();
    public static final ItemEntry<CannedFoodItem> compressed_biscuits = REGISTRATE
            ...
            .properties(p -> p.food(Foods.BREAD))
            .register();
    public static final ItemEntry<CannedFoodItem> packed_nuts = REGISTRATE
            ...
            .register();
    public static final ItemEntry<CannedFoodItem> dried_vegetables = REGISTRATE
    ...
    public static final ItemEntry<Item> chocolate = REGISTRATE
            ...
            .register();
    public static final ItemEntry<Item> RAW_WHALE_MEAT = REGISTRATE
            .item("raw_whale_meat", Item::new)
            .tag(CPTags.Items.MEAT)
            .properties(p -> p.food((new FoodProperties.Builder()).nutrition(4).saturationMod(0.8F).meat().fast().build()))
            .register();
    public static final ItemEntry<Item> COOKED_WHALE_MEAT = REGISTRATE
    ...
    public static final ItemEntry<SteamBottleItem> steam_bottle = REGISTRATE
            ...
            .model(FHBlockStateGen.existingItemModel())
            .register();
    public static final ItemEntry<SnowBreakerItem> snow_shovel = REGISTRATE
            ...
            .lang("Snow Shovel")
            .register();
    public static final ItemEntry<SnowBreakerItem> snow_broom = REGISTRATE
            ...
            .lang("Broom")
            .register();
    public static final ItemEntry<SnowSackItem> snow_sack_small = REGISTRATE
            ...
            .register();
    public static final ItemEntry<SnowSackItem> snow_sack_medium = REGISTRATE
            ...
            .register();
    public static final ItemEntry<SnowSackItem> snow_sack_large = REGISTRATE
            ...
            .register();
    public static final ItemEntry<SnowSackItem> snow_sack_huge = REGISTRATE
            ...
            .lang("Huge Snow Sack")
            .register();
    public static final ItemEntry<TownManagerItem> town_manager = REGISTRATE
    ...
    public static final ItemEntry<FHBaseArmorItem> hay_boots = REGISTRATE
            .item("hay_boots", p -> new FHBaseArmorItem(FHArmorMaterial.HAY, Type.BOOTS, createProps()))
            .model(FHBlockStateGen.existingItemModel())
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> hay_hat = REGISTRATE
            .item("hay_hat", p -> new FHBaseArmorItem(FHArmorMaterial.HAY, Type.HELMET, createProps()))
            .model(FHBlockStateGen.existingItemModel())
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> hay_jacket = REGISTRATE
            .item("hay_jacket", p -> new FHBaseArmorItem(FHArmorMaterial.HAY, Type.CHESTPLATE, createProps()))
            .model(FHBlockStateGen.existingItemModel())
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> hay_pants = REGISTRATE
    ...
    public static final ItemEntry<Item> hay_gloves = REGISTRATE
            ...
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> wool_boots = REGISTRATE
            .item("wool_boots", p -> new FHBaseArmorItem(FHArmorMaterial.WOOL, Type.BOOTS, createProps()))
            .model(FHBlockStateGen.existingItemModel())
            .lang("Wool Socks")
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> wool_hat = REGISTRATE
            .item("wool_hat", p -> new FHBaseArmorItem(FHArmorMaterial.WOOL, Type.HELMET, createProps()))
            .model(FHBlockStateGen.existingItemModel())
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> wool_jacket = REGISTRATE
            .item("wool_jacket", p -> new FHBaseArmorItem(FHArmorMaterial.WOOL, Type.CHESTPLATE, createProps()))
            .model(FHBlockStateGen.existingItemModel())
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> wool_pants = REGISTRATE
    ...
    public static final ItemEntry<Item> wool_gloves = REGISTRATE
            ...
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> hide_boots = REGISTRATE
            .item("hide_boots", p -> new FHBaseArmorItem(FHArmorMaterial.HIDE, Type.BOOTS, createProps()))
            .model(FHBlockStateGen.existingItemModel())
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> hide_hat = REGISTRATE
            .item("hide_hat", p -> new FHBaseArmorItem(FHArmorMaterial.HIDE, Type.HELMET, createProps()))
            .model(FHBlockStateGen.existingItemModel())
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> hide_jacket = REGISTRATE
            .item("hide_jacket", p -> new FHBaseArmorItem(FHArmorMaterial.HIDE, Type.CHESTPLATE, createProps()))
            .model(FHBlockStateGen.existingItemModel())
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> hide_pants = REGISTRATE
    ...
    public static final ItemEntry<Item> hide_gloves = REGISTRATE
            ...
            .register();
    // Rabbit
    public static final ItemEntry<FHBaseArmorItem> rabbit_fur_socks = REGISTRATE
            .item("rabbit_fur_socks", p -> new FHBaseArmorItem(FHArmorMaterial.RABBIT, Type.BOOTS, createProps()))
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> rabbit_hat = REGISTRATE
            .item("rabbit_fur_hat", p -> new FHBaseArmorItem(FHArmorMaterial.RABBIT, Type.HELMET, createProps()))
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> rabbit_jacket = REGISTRATE
            .item("rabbit_fur_jacket", p -> new FHBaseArmorItem(FHArmorMaterial.RABBIT, Type.CHESTPLATE, createProps()))
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> rabbit_pants = REGISTRATE
    ...
    public static final ItemEntry<Item> rabbit_gloves = REGISTRATE
            ...
            .register();
    // Fox
    public static final ItemEntry<FHBaseArmorItem> fox_boots = REGISTRATE
            .item("fox_fur_socks", p -> new FHBaseArmorItem(FHArmorMaterial.FOX, Type.BOOTS, createProps()))
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> fox_hat = REGISTRATE
            .item("fox_fur_hat", p -> new FHBaseArmorItem(FHArmorMaterial.FOX, Type.HELMET, createProps()))
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> fox_jacket = REGISTRATE
            .item("fox_fur_jacket", p -> new FHBaseArmorItem(FHArmorMaterial.FOX, Type.CHESTPLATE, createProps()))
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> fox_pants = REGISTRATE
    ...
    public static final ItemEntry<Item> fox_gloves = REGISTRATE
            ...
            .register();
    // Wolf
    public static final ItemEntry<FHBaseArmorItem> wolf_boots = REGISTRATE
            .item("wolf_fur_socks", p -> new FHBaseArmorItem(FHArmorMaterial.WOLF, Type.BOOTS, createProps()))
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> wolf_hat = REGISTRATE
            .item("wolf_fur_hat", p -> new FHBaseArmorItem(FHArmorMaterial.WOLF, Type.HELMET, createProps()))
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> wolf_jacket = REGISTRATE
            .item("wolf_fur_jacket", p -> new FHBaseArmorItem(FHArmorMaterial.WOLF, Type.CHESTPLATE, createProps()))
            .tag(FHTags.Items.INNER_LINNING.tag)
            .register();
    public static final ItemEntry<FHBaseArmorItem> wolf_pants = REGISTRATE
    ...
    public static final ItemEntry<Item> wolf_gloves = REGISTRATE
            ...
            .register();
    // Polar Bear
    public static final ItemEntry<FHBaseArmorItem> polar_bear_boots = REGISTRATE
            .item("polar_bear_fur_socks", p -> new FHBaseArmorItem(FHArmorMaterial.POLAR_BEAR, Type.BOOTS, createProps()))
            .register();
    public static final ItemEntry<FHBaseArmorItem> polar_bear_hat = REGISTRATE
            .item("polar_bear_fur_hat", p -> new FHBaseArmorItem(FHArmorMaterial.POLAR_BEAR, Type.HELMET, createProps()))
            .register();
    public static final ItemEntry<FHBaseArmorItem> polar_bear_jacket = REGISTRATE
    ...
    public static final ItemEntry<MushroomBed> red_mushroombed = REGISTRATE
            ...
            .lang("Red Fungus Bed")
            .register();
    public static final ItemEntry<MushroomBed> brown_mushroombed = REGISTRATE
            ...
            .register();
    public static final ItemEntry<CeramicBucket> ceramic_bucket = REGISTRATE
            .item("ceramic_bucket", CeramicBucket::new)
            .properties(p -> p.stacksTo(1))
            .model(FHBlockStateGen.existingItemModel())
            .register();

    public static final ItemEntry<FHBaseArmorItem> weatherHelmet = REGISTRATE
    ...
    // Thermos
    public static final ItemEntry<ThermosItem> thermos = REGISTRATE
            ...
            .lang("Thermos")
            .register();
    public static final ItemEntry<ThermosItem> advanced_thermos = REGISTRATE.item("advanced_thermos", p -> new ThermosItem(3000, true))
            .model(FHBlockStateGen.existingItemModel())
            .tag(FHTags.Items.INSULATED_FOOD.tag)
            .tag(FHTags.Items.THERMOS.tag)
            .tag(CPTags.Items.CONTAINER)
  ...
  /*  public static final ItemEntry<FHBaseClothesItem> DEBUG_CLOTH = REGISTRATE
    ...
    public static final ItemEntry<FluidBottleItem> fluid_bottle = REGISTRATE
            .item("fluid_bottle", FluidBottleItem::new)
            .tag(CPTags.Items.CONTAINER)
            .properties(p -> p.stacksTo(16))
            .model(FHBlockStateGen.existingItemModel())
            .register();
    public static final ItemEntry<WoodenCupItem> wooden_cup = REGISTRATE
    ...
    public static final ItemEntry<WoodenCupItem> wooden_cup_drink = REGISTRATE
            ...
            .register();
    public static final ItemEntry<LeatherWaterBagItem> LEATHER_WATER_BAG = REGISTRATE
            .item("leather_water_bag", p -> new LeatherWaterBagItem(new Item.Properties().stacksTo(1).setNoRepair(), 1000))
            .tag(CPTags.Items.CONTAINER)
            .model(FHBlockStateGen.existingItemModel())
            .lang("Leather Water Bag")
            .register();
    public static final ItemEntry<IronBottleItem> IRON_BOTTLE = REGISTRATE
    ...
    public static final ItemEntry<SledItem> SLED = REGISTRATE
