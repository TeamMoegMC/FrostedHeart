...
package com.teammoeg.frostedscenario.client.gui.layered;
...
import com.teammoeg.frostedscenario.client.gui.layered.gl.GLImageContent;
import com.teammoeg.frostedscenario.client.gui.layered.gl.GLLayerContent;
...
public class LayerManager extends GLLayerContent {
	...
	static ExecutorService renderThread=Executors.newFixedThreadPool(FSConfig.CLIENT.scenarioRenderThread.get(),CUtils.makeThreadFactory("scenario-render-pool", true));
	RerenderRequest rrq;
	
	public LayerManager() {
	}
	public LayerContext createContext() {
		return new LayerContext(new PriorityQueue<>(Comparator.comparingInt(OrderedRenderableContent::getZ).thenComparing(OrderedRenderableContent::getOrder)),new GLImageContent(null,0,0, 1f, 1f, 0, 0, 1024*FSConfig.CLIENT.getScenarioScale(), 576*FSConfig.CLIENT.getScenarioScale(), 1024*FSConfig.CLIENT.getScenarioScale(), 576*FSConfig.CLIENT.getScenarioScale()));
	}
