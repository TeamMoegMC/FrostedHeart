...
package com.teammoeg.frostedscenario.client.dialog;
...
public class ImageScreenDialog extends Screen implements IScenarioDialog {
	...
	public void render(GuiGraphics matrixStack, int mouseX, int mouseY, float partialTicks) {
		...
		if(escapes!=MAX_ESCAPE) {
			matrixStack.drawString(this.minecraft.font, Components.translatable("message.frostedheart.escape_count",escapes), 10, 10, 0xFFAAAAAA);
		}
	}
